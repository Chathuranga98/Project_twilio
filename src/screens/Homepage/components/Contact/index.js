...
function Contact() {
    ...
    const sendSMS=()=>{
        ...
        let sms ="New Message from"+username+message+"contact on"+phone;
        axios.post('',{
            Body:sms
        }).then(response =>{
    ...
    <section className="contact-section">
      ...
      <div className="columns">
        <div className="column is-6 contact-image-column">
            <img src="https://cdn.dribbble.com/users/1602563/screenshots/8869646/media/ddc33ce2c8e2570c410123f375e2c35c.gif" alt="abcd"/>
        </div>
